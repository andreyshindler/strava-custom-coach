...
def start_container(username: str, chat_id: str = ""):
    ...
    subprocess.run([
        ...
        "-e", f"NVIDIA_API_KEY={os.environ.get('NVIDIA_API_KEY', '')}",
        "-e", f"NVIDIA_CHAT_MODEL={os.environ.get('NVIDIA_CHAT_MODEL', '')}",
        "-e", f"NVIDIA_PLAN_MODEL={os.environ.get('NVIDIA_PLAN_MODEL', '')}",
        "-e", f"AI_PROVIDER={os.environ.get('AI_PROVIDER', '')}",
